...
BLOG_AUTHOR = "PyAr"  # (translatable)
BLOG_TITLE = "PyConAr 2017"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ar.pycon.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ar.pycon.org/"
BLOG_EMAIL = "info@ar.pycon.org"
BLOG_DESCRIPTION = "Sitio para la 9° PyConAr"  # (translatable)
